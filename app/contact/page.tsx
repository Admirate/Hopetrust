...
const ContactCard = ({ info, idx }: { info: typeof contactInfo[0], idx: number }) => {
  ...
  return (
    <motion.a
      ...
      className="bg-white p-8 rounded-[32px] shadow-[0_10px_40px_rgba(0,0,0,0.04)] flex flex-col items-center text-center transition-all border border-transparent hover:border-orange-100"
    >
      <div className={`p-4 rounded-2xl mb-4 ${info.color} relative w-16 h-16 flex items-center justify-center overflow-hidden`}>
          ...
          {isHovered ? (
            ...
            >
              <Image 
                ...
                unoptimized // Critical for GIFs to play properly in Next.js
              />
            </motion.div>
          ) : (
            <motion.div
      ...
      <h3 className="text-xl font-bold text-[#00373E] mb-2">{info.label}</h3>
      <p className="text-[#486364] leading-relaxed">{info.value}</p>
    </motion.a>
  );
};
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#6A8181]">Your Name</label>
                      <input
                        required
                        type="text"
                        placeholder="John Doe"
                        className="w-full bg-white/50 border-b-2 border-orange-100 px-4 py-3 rounded-xl focus:outline-none focus:border-orange-500 transition-colors"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold uppercase tracking-wider text-[#6A8181]">Phone Number</label>
                      <input
                        required
                        type="tel"
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-wider text-[#6A8181]">Email Address</label>
                    <input
                      required
                      type="email"
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-wider text-[#6A8181]">How can we help?</label>
                    <textarea
                      required
                      rows={4}
                      placeholder="Tell us a little about what you're looking for..."
                      className="w-full bg-white/50 border-b-2 border-orange-100 px-4 py-3 rounded-xl focus:outline-none focus:border-orange-500 transition-colors resize-none"
                    />
                  </div>
