...
excerpt: >-
  A psychiatric evaluation will determine if there are any co-occurring
  addictions, such as shopping along with substance abuse or other psychiatric
  disorders such as depression or obsessive-compulsive disorder (OCD).
  Psychological inputs such as CBT (cognitive behavioural therapy), motivational
  inter
categories:
  - Blog
featuredImage: /blog-images/Addiction.jpg
author: HopeTrust
wpLink: >-
  https://hopetrustindia.com/blog/what-is-non-substance-based-addiction-and-how-can-it-be-treated/
---

([What exactly is addiciton treatment?](/blogs/what-exactly-is-addiciton-treatment/)) is an obsessive and compulsive indulgence involving consumption of a substance (such as alcohol or other chemicals) or a behavior pattern. The substances or drugs are mood altering and the individual gets a “high” or a pleasurable sensation in the brain.
