...
All diseases are identified by a cluster of symptoms (what the patient subjectively reports) and signs (what the observer can see or measure). The characteristic signs and ([How Do We Define Alcoholism?](/blogs/how-do-we-define-alcoholism/)) are directly linked to alcohol’s effects on the central nervous system. As time goes by and the disease progresses, the symptoms and signs increase in number and severity as virtually every organ system in the body is progressively damaged.
...
This is the beginning of alcohol addiction. It progresses on to the middle stage and the late stage. It is easier and less harmful to intervene at an early stage for ([Hope Trust](/)).
