...
excerpt: "This approach helps each participant see a success story, when one member of the group succeeds; it creates a positive response from other group members. Allowing each member to see that others share the same struggles can be an important part of the recovery process."
categories:
  - "Blog"
featuredImage: ""
author: "HopeTrust"
