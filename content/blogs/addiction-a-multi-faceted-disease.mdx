...
excerpt: >-
  Alcohol addiction is a disease that affects the brain, liver, heart, and other
  vital functions of the body. Dependence on alcohol is defined as a disease by
  the American Medical Association and other leading medical authorities,
  because there are identifiable symptoms and characteristics that follow
categories:
  - Blog
featuredImage: ''
author: HopeTrust
