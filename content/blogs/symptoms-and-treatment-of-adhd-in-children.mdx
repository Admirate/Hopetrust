...
There is no specific lab test used to diagnose ADHD. Instead, ([our mental health services](/mental-health/)) can assess a child’s characteristics and determine whether or not the criteria are met. Several techniques are frequently used to gather information about a child’s behaviour.
...
While these tools are widely used, consider consulting with ([our mental health services](/mental-health/)). A provider who understands ADHD or has lived experience as an individual with ADHD can offer affirming support without pathologising the symptoms of ADHD.
...
A school psychologist or ([our therapists](/book-your-session/)) be able to make recommendations to help teachers provide a child with a learning environment that reduces ADHD symptoms.
...
_Click_ ([Hope Trust](/)) _to book an appointment with a therapist._
